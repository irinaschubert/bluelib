...
CREATE TABLE IF NOT EXISTS `bluelib`.`mitarbeiter` (
  ...
  INDEX `fk_Mitarbeiter_statusMA1_idx` (`statusMA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`mediumAutor` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Medium_has_Autor_Autor1_idx` (`autor_id` ASC) VISIBLE,
  INDEX `fk_Medium_has_Autor_Medium1_idx` (`medium_id` ASC) VISIBLE,
