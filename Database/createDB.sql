...
CREATE TABLE IF NOT EXISTS `bluelib`.`person` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Person_Anrede1_idx` (`anrede_id` ASC) VISIBLE,
  INDEX `fk_Person_Ort1_idx` (`ort_id` ASC) VISIBLE,
  INDEX `fk_Person_Mitarbeiter1_idx` (`mitarbeiter_id` ASC) VISIBLE,
  INDEX `fk_Person_StatusPers1_idx` (`statusPers_id` ASC) VISIBLE,
  INDEX `fk_Person_Person1_idx` (`person_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`medium` (
  ...
  `erscheinungsjahr` SMALLINT NULL,
  ...
  `person_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Medium_Verlag1_idx` (`verlag_id` ASC) VISIBLE,
  INDEX `fk_Medium_StatusMedi1_idx` (`statusMedi_id` ASC) VISIBLE,
  INDEX `fk_Person_person_id_idx` (`person_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`ausleihe` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Person_to_Medium_Person1_idx` (`person_id` ASC) VISIBLE,
  INDEX `fk_Person_to_Medium_Medium1_idx` (`medium_id` ASC) VISIBLE,
  INDEX `fk_erfasser_person_id_idx` (`erfasser_person_id` ASC) VISIBLE,
  INDEX `fk_retour_person_id_idx` (`retour_person_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`buch` (
  ...
  `medium_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Buch_Medium1_idx` (`medium_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`tondokumente` (
  ...
  `medium_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_CD_DVD_Medium1_idx` (`medium_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`film` (
  ...
  `medium_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_x_Medium1_idx` (`medium_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`stammdaten` (
  ...
  `ort_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_stammdaten_ort1_idx` (`ort_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`dezKla` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_DezKla_DezGrp1_idx` (`dezGrp_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`inventur` (
  ...
  `person_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Inventur_Person1_idx` (`person_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`inventurMedium` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Inventur_has_Medium_Medium1_idx` (`medium_id` ASC) VISIBLE,
  INDEX `fk_Inventur_has_Medium_Inventur1_idx` (`inventur_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bluelib`.`mediumSchlagwort` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_medium_has_schlagwort_schlagwort1_idx` (`schlagwort_id` ASC) VISIBLE,
  INDEX `fk_medium_has_schlagwort_medium1_idx` (`medium_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `bluelib`.`autorBuch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bluelib`.`autorBuch` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `autor_id` INT NOT NULL,
  `buch_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_autor_has_buch_buch1_idx` (`buch_id` ASC) VISIBLE,
  INDEX `fk_autor_has_buch_autor1_idx` (`autor_id` ASC) VISIBLE,
  CONSTRAINT `fk_autor_has_buch_autor1`
    FOREIGN KEY (`autor_id`)
    REFERENCES `bluelib`.`autor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_autor_has_buch_buch1`
    FOREIGN KEY (`buch_id`)
    REFERENCES `bluelib`.`buch` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
